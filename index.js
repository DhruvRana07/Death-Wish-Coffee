...
// First Slider
function fetchData(){
    fetch("https://project-json-ezbg.onrender.com/data").then((response)=>response.json()).then((data)=>productCardList(data)).catch((err)=>console.log(err))
}
fetchData()
...
function fetchsellerData(){
    fetch('https://project-json-ezbg.onrender.com/seller-Data').then((resp)=>resp.json()).then((data)=>sellerCardList(data)).catch((err)=>console.log(err))
}
fetchsellerData()
